...
# Note : metadata.csv est identique à dataset_alignment.csv
# On le resauvegarde pour garantir l'alignement parfait avec embeddings.npy
# (même ordre des lignes, même nombre de lignes)
